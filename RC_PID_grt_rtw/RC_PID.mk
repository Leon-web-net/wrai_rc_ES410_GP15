###########################################################################
## Makefile generated for component 'RC_PID'. 
## 
## Makefile     : RC_PID.mk
## Generated on : Thu Feb 19 02:09:16 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\RC_PID.exe
...
START_DIR                 = C:\Users\letio\MATLAB~1\GP_ES410\CONTRO~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = RC_PID_comp.rsp
CMD_FILE                  = RC_PID.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\RC_PID.exe
...
DEFINES_STANDARD = -DMODEL=RC_PID -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\RC_PID_grt_rtw\RC_PID.c $(START_DIR)\RC_PID_grt_rtw\RC_PID_data.c $(START_DIR)\RC_PID_grt_rtw\rt_nonfinite.c
...
OBJS = rt_logging.obj RC_PID.obj RC_PID_data.obj rt_nonfinite.obj
...
{$(START_DIR)\RC_PID_grt_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\RC_PID_grt_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\RC_PID_grt_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\RC_PID_grt_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
RC_PID.obj : "$(START_DIR)\RC_PID_grt_rtw\RC_PID.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\RC_PID_grt_rtw\RC_PID.c"


RC_PID_data.obj : "$(START_DIR)\RC_PID_grt_rtw\RC_PID_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\RC_PID_grt_rtw\RC_PID_data.c"


rt_nonfinite.obj : "$(START_DIR)\RC_PID_grt_rtw\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\RC_PID_grt_rtw\rt_nonfinite.c"
